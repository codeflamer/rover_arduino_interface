...
struct Config
{
  ...
  std::string base_link_bottom_right_wheel = "";
  std::string base_link_to_front_right_wheel = "";

  std::string base_link_to_bottom_left_wheel = "";
  std::string base_link_to_front_left_wheel = "";
  float loop_rate = 0.0;
  std::string device = "";
  int baud_rate = 0;
  int timeout_ms = 0;
